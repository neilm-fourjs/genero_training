...
END FUNCTION
--------------------------------------------------------------------------------
FUNCTION setup_actions( l_d ui.Dialog, l_tf BOOLEAN )
	CALL l_d.setActionActive( "next", l_tf )
	CALL l_d.setActionActive( "previous", l_tf )
	CALL l_d.setActionActive( "delete", l_tf )
	CALL l_d.setActionActive( "update", l_tf )
END FUNCTION
--------------------------------------------------------------------------------
