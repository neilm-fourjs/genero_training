...
FUNCTION display_custlist()
	...
	DECLARE custlist_curs CURSOR FOR SELECT store_num, store_name, city FROM customer ORDER BY store_num
	...
	IF idx > 0 THEN
		LET int_flag = FALSE
		DISPLAY ARRAY cust_arr TO sa_cust.* ATTRIBUTES(COUNT = idx)
